...
class Parameter :
    def __init__(self):
        ...
        self.parameter_model ={
            ...
            'P_i':[-0.0498, 0.00506, -0.025, 0.0014, -0.00041, 0.0105, -0.036, 0.0074, 0.0012, -0.0407], # same TF for E and I(08/11/2022)
        ...
        self.parameter_coupling={
            ...
            'parameter':{'a':0.1, # changed from 0.45 to 0.25 (14/09/2021) then to 0.20 (15/09/2021)
                         'b':0.0}
        }
