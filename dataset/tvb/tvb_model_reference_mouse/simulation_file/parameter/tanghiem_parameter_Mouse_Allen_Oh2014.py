...
class Parameter :
    def __init__(self):
        ...
        self.parameter_model ={
            ...
            'K_ext_e':400,
            'K_ext_i':0,
            'ratio_EI_EE':1., # TAN added to control ratio of E to E vs E to I inter-region projections
            #Initial condition :
            'initial_condition':{
        ...
        self.parameter_connection_between_region={
            ...
            'from_h5':True,
            'from_folder':True,
            'path':path+'/../../data/Mouse_512/Connectivity_Allen_Oh2014.h5', #the files
            # File description
        ...
        self.parameter_coupling={
            ...
            'parameter':{'a':0.45, # changed from 0.25 to 0.45 (TAN 2023/09/06)
                         'b':0.0}
        }
        ...
        self.parameter_monitor= {
            ...
            'parameter_TemporalAverage':{
                ...
                'period':self.parameter_integrator['dt']*200.0
            },
            'Bold':False,
            'parameter_Bold':{
